    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6 space-y-6">
          ...
          {activeTab === 'notifications' && (
            <>
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600 ml-7">Get notified about budget alerts, upcoming bills, and financial insights.</p>
                ...
                <p className="text-sm text-gray-600 ml-7">Receive real-time notifications on your device.</p>
              </div>
            </>
          )}
          ...
          {activeTab === 'privacy' && (
            <>
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600 ml-7">Add an extra layer of security to your account.</p>

                <div className="mt-6 p-4 bg-blue-50 rounded border border-blue-200">
                  <h3 className="font-bold text-blue-900 mb-2">🔐 Data Security</h3>
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded">
                  ...
                  <p className="text-sm text-gray-600 mb-4">Manage your connected bank accounts and integrations.</p>
          ...
          {activeTab === 'account' && (
            <>
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded">
                <h3 className="font-bold mb-3">Budgeting Preference</h3>
                <p className="text-sm text-gray-600 mb-3">Choose your default budgeting methodology:</p>
              ...
              <div className="mt-6">
                ...
                <p className="text-xs text-gray-600 mt-2">This action is permanent and cannot be undone.</p>
              </div>
            </>
          )}
        </div>
        ...
        <div className="border-t border-gray-200 p-6 flex justify-end gap-3">
          <button className="px-4 py-2 text-gray-700 border border-gray-300 rounded hover:bg-gray-50">Cancel</button>
          <button
